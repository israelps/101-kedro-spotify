...
# kedro_spotify_101 documentation build
...
from kedro_spotify_101 import __version__ as release

# -- Project information -----------------------------------------------------

project = "kedro_spotify_101"
author = "QuantumBlack"
...
htmlhelp_basename = "kedro_spotify_101doc"
...
latex_documents = [
    (
        master_doc,
        "kedro_spotify_101.tex",
        "kedro_spotify_101 Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "kedro_spotify_101",
        "Project kedro_spotify_101 codebase.",
        "Data-Science",
    )
]
